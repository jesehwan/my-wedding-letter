...
export function ExploreCard({ onClick }: ExploreCardProps) {
  return (
    ...
    >
      ...
      <button
        onClick={onClick}
        className="absolute bottom-4 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full bg-rose-400 px-6 py-2 text-white transition-all hover:bg-rose-500 hover:shadow-lg"
      >
        신혼집 구경하기
      </button>
    </div>
